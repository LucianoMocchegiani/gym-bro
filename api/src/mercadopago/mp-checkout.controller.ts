...
import { MpCartCheckoutResult, MpCheckoutResult } from './mp-checkout.types';
...
export class MpCheckoutController {
  ...
  @Post('members/:memberId/payments/mp/cart')
  @HttpCode(HttpStatus.CREATED)
  @RequirePermission('members.write')
  startStaffCartCheckout(
    ...
    return this.checkout.startCartCheckout(tenantId, memberId, dto);
  }
}
