...
- Package Dart en raíz: `identity-core-dart/` (nombre pub `identity_core_dart`; antes `ssi-quark/quarkid-identity-core-dart`). Persistencia local de VCs: [mobile/isar-wallet.md](./mobile/isar-wallet.md).
