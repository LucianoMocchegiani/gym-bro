...
| Débito automático (packs MONTHLY) | Diseño cerrado; código viejo | **P2.** Suscripción MP + `init_point` (2026-09-15). Reemplazar tarjeta+job. RN-PAG-013..016, CU-PAG-008..010. [18](../18-prioridades-cierre-mvp.md) · P9 en `08`. |
