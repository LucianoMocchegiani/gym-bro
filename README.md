...
| Servicio | URL / puerto |
|----------|----------------|
| Web | http://localhost:3000 — Admin (inicio, afiliados, catálogo, roles/config, caja, puerta) |
