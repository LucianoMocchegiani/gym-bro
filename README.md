...
Modelo: **1 producto** Faciliter → **1 issuer + 1 verifier** compartidos para todos los gyms. Distinción por claims (`tenantId`, `packId`). Docs: [kuatia.xyz/docs](https://kuatia.xyz/docs).
