...
En ambos casos: **puede equivocarse. No cobra, no enrola débito, no devuelve plata, no da de alta.** Las acciones reales son en las pantallas del Admin. Para cómo se ve cada pantalla: `get_help` topic `guia`; las fotos están en `/docs`. Si hay un **problema** o piden una persona: `get_help` topic `soporte`.
