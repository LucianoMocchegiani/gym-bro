...
- La misma persona en la vida real puede ser profesor y socio: en el sistema son **dos perfiles**.
...
Hoy la tienda del establecimiento vende **servicios** (packs y drop-in). **Productos físicos** y **noticias/avisos del local** no están todavía: no los presentes como si ya anduvieran.
